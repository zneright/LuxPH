...
impl InvoicePaymentContract {
    ...
    pub fn set_merchant_lock_duration(env: Env, merchant: Address, lock_duration_seconds: i64) {
    ...
    pub fn pay_invoice(
        ...
        if merchant_share > 0 {
            token_client.transfer(contract_address.clone(), merchant.clone(), merchant_share);
        }
