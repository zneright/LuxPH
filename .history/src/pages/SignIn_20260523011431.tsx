...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-[#080b14] text-[#e5e7eb] font-['Nunito',sans-serif] flex items-center justify-center relative overflow-hidden">
      ...
      <button
        onClick={() => navigate("/")}
        className="absolute top-6 left-6 md:top-8 md:left-8 z-20 flex items-center gap-2 text-[#9ca3af] hover:text-white transition-all text-sm font-semibold cursor-pointer bg-white/5 hover:bg-white/10 px-4 py-2.5 rounded-full border border-white/10 hover:shadow-lg backdrop-blur-sm"
      >
      ...
      <div className="relative z-10 w-full max-w-md p-8 bg-white/[0.04] border border-white/[0.08] rounded-2xl backdrop-blur-md shadow-2xl mx-4">
