                    ...
                    <AnimatePresence mode="wait">
                        {activeTab === 'dashboard' ? (
                            <motion.div key="dashboard" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }} className="vault-card">
                                ...
                                <div style={{ background: "rgba(0,0,0,0.4)", borderRadius: 12, padding: 16, fontFamily: "'DM Mono', monospace", fontSize: 11, minHeight: "100px", maxHeight: "250px", overflowY: "auto" }}>
                                    {recentLogs.map(log => (
