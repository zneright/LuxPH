          ...
          >
            <div style={{ width: "100%", maxWidth: 480 }}>
              ...
              <div id="printable-receipt" style={{ background: "#ffffff", borderRadius: 16, padding: "32px 32px 40px", position: "relative", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.5)", overflow: "hidden" }}>
                ...
                {/* LOGO ADDED HERE FOR THE PDF EXPORT */}
                <div style={{ textAlign: "center", marginBottom: 16, marginTop: 16 }}>
                  {/* NOTE: Make sure /logo.png exists in your public folder, or change this to your absolute logo URL */}
                  <img src="/logo.png" alt="System Logo" style={{ height: 42, objectFit: "contain" }} onError={(e) => { e.currentTarget.style.display = 'none'; }} />
                </div>
