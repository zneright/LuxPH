          ...
          >
            <div style={{ width: "100%", maxWidth: 480 }}>
              ...
              <div id="printable-receipt" style={{ background: "#ffffff", borderRadius: 16, padding: "32px 32px 40px", position: "relative", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.5)", overflow: "hidden" }}>
                ...
                {/* LUX PH LOGO AND TEXT FOR PDF EXPORT */}
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 16, marginTop: 16 }}>
                  ...
                  <span style={{ fontSize: 24, fontWeight: 900, color: "#0a2540", fontFamily: "'Nunito',sans-serif", letterSpacing: "1px" }}>LUX PH</span>
                </div>
