Here is the full, corrected code for `CreateInvoice.tsx`, incorporating the array fix for `parsedArgs` so your React state values are properly passed to the Soroban contract.
...
export default function CreateInvoice() {
  ...
  const [contractArgs, setContractArgs] = useState("customerName,amount,token,memo"); // Kept for the input field UI
...
const handleStartListening = async () => {
  ...
  if (useContractInvoice) {
    ...
    // FIXED: Use direct React state values instead of splitting the contractArgs string
    const parsedArgs = [
