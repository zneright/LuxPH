...
export default function ContingencyVault() {
    ...
    const executeVaultLock = async (kp: Keypair, amountToLock: string) => {
        try {
            ...
            // THE FIX: Using the correct Stellar SDK method names
            const strictTimePredicate = ClaimPredicate.predicateNot(
                ClaimPredicate.predicateBeforeAbsoluteTime(unlockUnixSeconds)
            );
