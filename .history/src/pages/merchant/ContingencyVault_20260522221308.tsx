...
export default function ContingencyVault() {
    ...
    const syncHorizonData = async (kp: Keypair) => {
        ...
        try {
            ...
            setCurrentPage(1); // Reset pagination on new sync
    ...
    const handleUnlockSession = () => {
        try {
            ...
            // Note: If you fully move to Firebase Functions, you can remove this listener from the frontend.
            // Kept here in case you want hybrid functionality.
            if (config.isEnabled) {
