    ...
    const executePayment = async (scannedDest?: string, scannedAmount?: string, scannedToken?: string) => {
        ...
        try {
            ...
            if (useContractPayment) {
                ...
                if (!effectiveContractId || !effectiveContractId.trim()) return alert("Soroban contract ID is not configured. Please contact your system administrator to deploy and configure the payment contract.");
