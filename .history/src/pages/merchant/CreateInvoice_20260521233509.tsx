    ...
    if (useContractInvoice) {
      ...
      try {
        ...
        if (errorMsg.includes("non-existing value") || errorMsg.includes("contract instance")) {
          return alert(`Failed to invoke contract. The contract ID may not be deployed on this network. Contract: ${effectiveContractId}`);
        }
        if (errorMsg.includes("insufficient auth")) {
          return alert("Failed to authorize the contract invocation. Please ensure your wallet is properly connected.");
        }
