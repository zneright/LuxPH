...
import { useWallet } from "../../contexts/WalletContext"; // 🚨 ADDED: Bring in your unified context
...
export default function SendPayment() {
    ...
    // 🚨 ADDED: Extract signTx from your WalletContext
    ...
    const executePayment = async (scannedDest?: string) => {
        ...
        try {
            ...
            // 🚨 FIX: Replaced direct Freighter call with your universal signTx wrapper!
            let signedXdrString = "";
            try {
