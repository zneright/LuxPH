        ...
        try {
            ...
            if (useContractPayment) {
                if (errorMsg.includes("non-existing value") || errorMsg.includes("contract instance")) {
                    errorMsg = `Failed to invoke contract. The contract may not be deployed on this network. Contract: ${contractId || systemConfig.sorobanContractId}`;
                } else if (errorMsg.includes("insufficient auth")) {
                    errorMsg = "Failed to authorize the contract invocation. Please ensure your wallet is properly connected and has sufficient funds for the transaction.";
                } else if (errorMsg.includes("simulation")) {
                    errorMsg = `Contract simulation failed. Please verify the contract arguments and ensure they match the contract function signature.`;
                }
            }
