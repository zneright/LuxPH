                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                    ...
                    <div style={{ borderTop: "1px solid rgba(255,255,255,.06)", paddingTop: 16, marginTop: 8 }}>
                      <div className="co-method-shelf">
                        <button type="button" onClick={() => setPayoutMethod("bank")} style={{ flex: 1, padding: 10, borderRadius: 8, background: payoutMethod === "bank" ? "rgba(16, 185, 129, 0.15)" : "rgba(255, 255, 255, 0.23)", border: payoutMethod === "bank" ? "1px solid #10b981" : "1px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all 0.2s" }}>
                        ...
                        <button type="button" onClick={() => setPayoutMethod("gcash")} style={{ flex: 1, padding: 10, borderRadius: 8, background: payoutMethod === "gcash" ? "rgba(59, 130, 246, 0.15)" : "rgba(255, 255, 255, 0.27)", border: payoutMethod === "gcash" ? "1px solid #3b82f6" : "1px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all 0.2s" }}>
                        ...
                        <button type="button" onClick={() => setPayoutMethod("qr")} style={{ flex: 1, padding: 10, borderRadius: 8, background: payoutMethod === "qr" ? "rgba(16, 185, 129, 0.15)" : "rgba(255, 255, 255, 0.23)", border: payoutMethod === "qr" ? "1px solid #10b981" : "1px solid transparent", cursor: "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, transition: "all 0.2s" }}>
                          <img src="https://upload.wikimedia.org/wikipedia/commons/3/35/QR_Ph_Logo.svg?utm_source=commons.wikimedia.org&utm_campaign=index&utm_content=original" alt="QR Ph" height="18" style={{ filter: payoutMethod !== "qr" ? "grayscale(100%) opacity(0.7)" : "none", transition: "all 0.2s" }} />
                        </button>
                      </div>
