          ...
          >
            <div style={{ width: "100%", maxWidth: 480 }}>
              ...
              <div id="printable-receipt" style={{ background: "#ffffff", borderRadius: 16, padding: "32px 32px 40px", position: "relative", overflow: "hidden" }}>
                ...
                {/* MATCHING THE IMAGE HEADER */}
                <div style={{ display: "flex", alignItems: "center", justifyContent: "center", gap: 12, marginBottom: 24, marginTop: 8 }}>
                  <img src="/images/luxphlogo.svg" alt="Lux PH Icon" style={{ height: 32, objectFit: "contain" }} crossOrigin="anonymous" />
                  <span style={{ fontSize: 28, fontWeight: 900, color: "#0f172a", fontFamily: "'Nunito',sans-serif", letterSpacing: "0.5px" }}>LUX PH</span>
                </div>

                <div style={{ textAlign: "center", marginBottom: 32 }}>
                  {/* MATCHING THE IMAGE CHECKMARK (SVG instead of Text character) */}
